...
void main(){
	...
	printf("|1-Insert(rear)|\t|2-Delete(front)|\t|3-Insert(front)|\t|4-Delete(rear)|\n|5-Display|\t|6-Insert before element|\t|7-Insert after element|\t|8-Delete element|\t|9-Delete every second node|\t|10-Delete linked list & Exit|\n");
	while(flag){
		printf("->");
